            ...
            if sample_data.get('has_stress_strain_data', False):
                ...
                if key and key in self.stress_strain_data:
                    ...
                    try:
                        ...
                        if 'True Stress' in ss_df.columns and 'True Strain' in ss_df.columns:
                            plt.figure(figsize=(10, 6))
                            
                            stress = ss_df['True Stress']
                            strain = ss_df['True Strain']
    ...
    def create_main_visualizations(self):
        ...
        if self.stress_strain_data:
            ...
            for key, df_ss in self.stress_strain_data.items():
                if 'True Stress' in df_ss.columns and 'True Strain' in df_ss.columns and plot_count < 20:  # Limit for performance
